...
function Skills() {
  return (
    <section className="relative z-40">
      {/* Section title */}
      <div className="flex justify-center lg:pt-8 lg:pb-2">
      ...
      {/* Marquee for skills */}
      <div className="w-full mt-10 mb-20 relative">
        {/* Marquee layer 1: from right to left */}
        <Marquee
          gradient={false}
          speed={80}
          pauseOnHover={true}
        ...
        {/* Marquee layer 2: from left to right */}
        <Marquee
          gradient={false}
          speed={80}
          pauseOnHover={true}
          ...
          play={true}
          direction="right"
          className="absolute pt-4 w-full bottom-0"
        >
          {skillsData.map((skill, id) => (
            <div
              className="w-36 min-w-fit h-fit flex flex-col items-center justify-center transition-all duration-500 m-3 sm:m-5 rounded-lg group relative hover:scale-[1.15] cursor-pointer"
